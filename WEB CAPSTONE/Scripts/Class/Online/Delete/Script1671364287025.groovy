...
WebUI.click(findTestObject('Object Repository/Page_Manage Online Classes - WorkFit/i_Loading_fi fi-rr-menu-dots-vertical'))

WebUI.click(findTestObject('Object Repository/Page_Manage Online Classes - WorkFit/button_Delete'))

WebUI.rightClick(findTestObject('Object Repository/Page_Manage Online Classes - WorkFit/button_Yes, Delete it'))

WebUI.click(findTestObject('Object Repository/Page_Manage Online Classes - WorkFit/div_Are you sureYou cant undo this action.N_bdb70d'))
