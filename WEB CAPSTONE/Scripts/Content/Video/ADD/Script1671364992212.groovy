...
WebUI.click(findTestObject('Object Repository/Page_Manage Video - WorkFit/i_Manage Video_fi fi-rr-plus-small mr-1 mt-_7fb9c6'))

WebUI.click(findTestObject('Object Repository/Page_Manage Video - WorkFit/div_Title_inset-0 flex h-52 w-80 items-cent_8ac936'))

WebUI.click(findTestObject('Object Repository/Page_Manage Video - WorkFit/div_Title_flex h-52 w-80 flex-col items-cen_392f40'))
