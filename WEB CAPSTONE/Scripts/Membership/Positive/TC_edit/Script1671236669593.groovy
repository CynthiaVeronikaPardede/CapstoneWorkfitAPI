...
WebUI.setText(findTestObject('Object Repository/Page_Manage Membership - WorkFit/input_Edit Membership_email'), 'rivaldogabriel1@gmail.com')

WebUI.click(findTestObject('Object Repository/Page_Manage Membership - WorkFit/button_Save'))

WebUI.click(findTestObject('Object Repository/Page_Manage Membership - WorkFit/h2_Updated'))
