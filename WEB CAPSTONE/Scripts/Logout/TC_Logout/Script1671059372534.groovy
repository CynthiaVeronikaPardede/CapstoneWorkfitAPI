...
WebUI.click(findTestObject('Object Repository/Page_Dashboard - WorkFit/span_Logout'))

WebUI.click(findTestObject('Object Repository/Page_Dashboard - WorkFit/button_Yes, Logout'))
