...
WebUI.click(findTestObject('Object Repository/Page_Manage Instructor - WorkFit/button_qe1gmail.com_rounded-lg bg-secondary_c052bb'))

WebUI.click(findTestObject('Object Repository/Page_Manage Instructor - WorkFit/button_Yes, Delete it'))

WebUI.click(findTestObject('Object Repository/Page_Manage Instructor - WorkFit/h2_Deleted'))
