...
WebUI.click(findTestObject('Object Repository/Page_Manage Workout - WorkFit/button_Editss_rounded-lg bg-secondary-red p_e26c0b'))

WebUI.click(findTestObject('Object Repository/Page_Manage Workout - WorkFit/button_No, Cancel'))
