...
WebUI.click(findTestObject('Object Repository/Page_Manage Workout - WorkFit/td_Editss_py-3 px-6'))

WebUI.click(findTestObject('Object Repository/Page_Manage Workout - WorkFit/i_Editss_fi fi-sr-pencil text-sm'))

WebUI.click(findTestObject('Object Repository/Page_Manage Workout - WorkFit/button_Cancel'))
