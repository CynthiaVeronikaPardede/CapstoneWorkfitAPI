...
WebUI.click(findTestObject('Object Repository/Page_Manage Instructor - WorkFit/span_Add New'))

WebUI.click(findTestObject('Object Repository/Page_Manage Instructor - WorkFit/input_Add New Instructor_instructor_name'))
