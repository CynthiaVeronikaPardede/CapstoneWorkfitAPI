...
WebUI.setText(findTestObject('Object Repository/Page_Manage Instructor - WorkFit/input_Manage Instructor_block w-full rounde_e3cf5d'), 
    'Mane')

WebUI.click(findTestObject('Object Repository/Page_Manage Instructor - WorkFit/div_Mane'))
