...
//POST method
response = WS.sendRequest(findTestObject('Booking/Online Book/See all boking class/With POST Method'))

WS.verifyResponseStatusCode(response, GlobalVariable.StatusCode401)

response = WS.sendRequest(findTestObject('Booking/Online Book/See all boking class/With PUT Method'))
